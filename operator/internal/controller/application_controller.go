...
func (r *ApplicationReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	// custom reconciliation logic for vulkan orgs
	var org platformv1alpha1.Org
	if err := r.Get(ctx, client.ObjectKey{Name: req.Name}, &org); err != nil {
		logf.FromContext(ctx).Error(err, "unable to fetch Org", "name", req.Name)
